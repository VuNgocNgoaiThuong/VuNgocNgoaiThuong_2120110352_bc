<section class="hdl-footer pb-4">
      <div class="container">
         <div class="row">
            <div class="col-md-4 pt-4">
               ...
               <p class="pt-1">
                  Copyright@ 2024 NgoaithuongShop là hệ thống bán sĩ và lẽ thời trang nam, nữ, trẻ em và quần áo thể thao,
   ...
   <section class="dhl-copyright bg-dark py-3">
      <div class="container text-center text-white">
         Thiết kế bởi: Vũ Ngọc Ngoại Thương - Phone: 0998765432
      </div>
   </section>
</body>
