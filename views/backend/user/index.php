      ...
      <div class="container-fluid">
         <div class="row mb-2">
            <div class="col-sm-12">
               ...
               <a href="index.php?option=user&cat=create" class="btn btn-sm btn-primary">Thêm </a>
            </div>
         </div>
      </div>
   </section>
                  ...
                  <?php if (count($list) > 0) : ?>
                     <?php foreach ($list as $item) : ?>
                        <tr class="datarow">
                           ...
                           <td>
                           <img style="width: 40px; height: 40px;" src="../public/images/user/<?= $item->image; ?>" alt="<?= $item->image; ?>">
                           </td>
                           <td>
                              <div class="name">
                                 <?= $item->name; ?>
